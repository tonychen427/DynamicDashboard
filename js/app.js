$(document).ready(function() {
    ...
    var viewModelColumn = function(mData, mColumnSize) {
        var self = this;
        var data = [];
        $.each(mData.widgetList, function(i, v) {
            data.push(new viewModelWidget(v));
        });
        self.id = mData.id;
    ...
    var viewModelPanel = function(mData) {
        ...
        self.layouts = [{
            ...
            'columns': [{
                'text': '100%',
                'css': 'col-md-12 spaceFix'
            }]
        }, {
            'title': 'Two Column',
            'columns': [{
                'text': '50%',
                'css': 'col-md-6 spaceFix'
            }, {
                'text': '50%',
                'css': 'col-md-6 spaceFix'
            }]
        ...
        $.each(mData.columnsList, function(i, v) {
            data.push(new viewModelColumn(v, mData.columnsList.length));
        });
    ...
    var viewModelDashboard = function(mData) {
        ...
        $.each(mData, function(i, v) {
            data.push(new viewModelPanel(v));
        });
        var dummyReport = [{
            'id': '_reportId01',
            'reportName': 'Company Summary',
            'css': 'active',
            'reportsList': [
                new viewModelWidget({
                    'id': '_widget5',
                    ...
                    'widgetData': tempChart
                }),
                new viewModelWidget({
                    'id': '_widget6',
                    'widgetName': 'Report 2',
                    'widgetType': 'highcharts',
                    'widgetData': tempChart2
                }),
                new viewModelWidget({
                    'id': '_widget7',
                    'widgetName': 'Report 3',
